...
# Параметры
BUNDLE_ID="com.plsmartstead.upon"
APPLE_ID="6748222936"
REMOTE_URL="git@github.com:sdeslvm/Play-smart.-Grow-steady.git"
PROJECT_NAME="Play smart. Grow steady"
SCHEME_NAME="Play smart. Grow steady"
