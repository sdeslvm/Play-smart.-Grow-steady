...
protocol PlaySmartWebLoadable: AnyObject {
    var state: PlaySmartWebStatus { get set }
    func setConnectivity(_ available: Bool)
}

/// Протокол для мониторинга прогресса загрузки
protocol PlaySmartProgressMonitoring {
...
final class PlaySmartWebLoader: NSObject, ObservableObject, PlaySmartWebLoadable, PlaySmartProgressMonitoring {
    // MARK: - Свойства
    
    @Published var state: PlaySmartWebStatus = .standby
...
extension PlaySmartWebLoader: WKNavigationDelegate {
