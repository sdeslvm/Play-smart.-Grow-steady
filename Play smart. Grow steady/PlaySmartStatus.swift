...
protocol PlaySmartWebStatusComparable {
...
enum PlaySmartWebStatus: Equatable, PlaySmartWebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: PlaySmartWebStatus) -> Bool {
        switch (self, other) {
...
extension PlaySmartWebStatus {
    static func == (lhs: PlaySmartWebStatus, rhs: PlaySmartWebStatus) -> Bool {
